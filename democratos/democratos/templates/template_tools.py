...
from django.template.base import TextNode, Template

#  https://djangosnippets.org/snippets/769/
...
def render_block_to_string(template_name,
                           block,
                           dictionary=None,
                           context_instance=None):
    """
    Loads the given template_name and renders
    the given block with the given dictionary as
    ...
    if not(isinstance(context_instance, Context)):
